...
public final class LodIndex extends Table {
  ...
  public LodIndexT unpack() {
    LodIndexT _o = new LodIndexT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(LodIndexT _o) {
    long _oUnk0 = unk0();
    _o.setUnk0(_oUnk0);
  }
  public static int pack(FlatBufferBuilder builder, LodIndexT _o) {
    if (_o == null) return 0;
    return createLodIndex(
      builder,
      _o.getUnk0());
  }
}
