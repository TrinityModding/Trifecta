...
public final class Transform extends Table {
  ...
  public void unpackTo(TransformT _o) {
    if (vecScale() != null) vecScale().unpackTo(_o.getVecScale());
    else _o.setVecScale(null);
    if (vecRot() != null) vecRot().unpackTo(_o.getVecRot());
    else _o.setVecRot(null);
    if (vecTranslate() != null) vecTranslate().unpackTo(_o.getVecTranslate());
    else _o.setVecTranslate(null);
  }
  public static int pack(FlatBufferBuilder builder, TransformT _o) {
    if (_o == null) return 0;
    startTransform(builder);
    addVecScale(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getVecScale()));
    addVecRot(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getVecRot()));
    addVecTranslate(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getVecTranslate()));
    return endTransform(builder);
  }
}
