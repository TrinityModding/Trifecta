...
public final class Int_Extra extends Table {
  ...
  public Int_ExtraT unpack() {
    Int_ExtraT _o = new Int_ExtraT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(Int_ExtraT _o) {
    long _oRes0 = res0();
    _o.setRes0(_oRes0);
    int _oValue = value();
    _o.setValue(_oValue);
  }
  public static int pack(FlatBufferBuilder builder, Int_ExtraT _o) {
    if (_o == null) return 0;
    return createInt_Extra(
      builder,
      _o.getRes0(),
      _o.getValue());
  }
