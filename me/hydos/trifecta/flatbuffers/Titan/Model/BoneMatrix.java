...
public final class BoneMatrix extends Table {
  ...
  public BoneMatrixT unpack() {
    BoneMatrixT _o = new BoneMatrixT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(BoneMatrixT _o) {
    ...
    if (w() != null) w().unpackTo(_o.getW());
    else _o.setW(null);
  }
  public static int pack(FlatBufferBuilder builder, BoneMatrixT _o) {
    if (_o == null) return 0;
    startBoneMatrix(builder);
    addX(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getX()));
    addY(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getY()));
    addZ(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getZ()));
    addW(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getW()));
    return endBoneMatrix(builder);
  }
}
