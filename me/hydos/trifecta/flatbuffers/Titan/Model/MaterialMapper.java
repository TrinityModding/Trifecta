...
public final class MaterialMapper extends Table {
  ...
  public MaterialMapperT unpack() {
    MaterialMapperT _o = new MaterialMapperT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(MaterialMapperT _o) {
    String _oMeshName = meshName();
    _o.setMeshName(_oMeshName);
    String _oMaterialName = materialName();
    _o.setMaterialName(_oMaterialName);
    String _oLayerName = layerName();
    _o.setLayerName(_oLayerName);
  }
  public static int pack(FlatBufferBuilder builder, MaterialMapperT _o) {
    if (_o == null) return 0;
    ...
    int _layerName = _o.getLayerName() == null ? 0 : builder.createString(_o.getLayerName());
    return createMaterialMapper(
      builder,
      _meshName,
      _materialName,
      _layerName);
