...
public final class StringParameter extends Table {
  ...
  public StringParameterT unpack() {
    StringParameterT _o = new StringParameterT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(StringParameterT _o) {
    String _oStringName = stringName();
    _o.setStringName(_oStringName);
    String _oStringValue = stringValue();
    _o.setStringValue(_oStringValue);
  }
  public static int pack(FlatBufferBuilder builder, StringParameterT _o) {
    if (_o == null) return 0;
    int _stringName = _o.getStringName() == null ? 0 : builder.createString(_o.getStringName());
