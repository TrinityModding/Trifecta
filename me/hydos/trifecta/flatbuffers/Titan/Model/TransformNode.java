...
public final class TransformNode extends Table {
  ...
  public me.hydos.trifecta.flatbuffers.Titan.Model.Transform transform() { return transform(new me.hydos.trifecta.flatbuffers.Titan.Model.Transform()); }
  public me.hydos.trifecta.flatbuffers.Titan.Model.Transform transform(me.hydos.trifecta.flatbuffers.Titan.Model.Transform obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 scalePivot() { return scalePivot(new me.hydos.trifecta.flatbuffers.Titan.Model.Vec3()); }
  public me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 scalePivot(me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(8); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 rotatePivot() { return rotatePivot(new me.hydos.trifecta.flatbuffers.Titan.Model.Vec3()); }
  public me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 rotatePivot(me.hydos.trifecta.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(10); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public TransformNodeT unpack() {
    TransformNodeT _o = new TransformNodeT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(TransformNodeT _o) {
    String _oName = name();
    _o.setName(_oName);
    if (transform() != null) _o.setTransform(transform().unpack());
    else _o.setTransform(null);
    if (scalePivot() != null) scalePivot().unpackTo(_o.getScalePivot());
    else _o.setScalePivot(null);
    if (rotatePivot() != null) rotatePivot().unpackTo(_o.getRotatePivot());
    else _o.setRotatePivot(null);
    int _oParentIdx = parentIdx();
    _o.setParentIdx(_oParentIdx);
    int _oRigIdx = rigIdx();
    _o.setRigIdx(_oRigIdx);
    String _oEffectNode = effectNode();
    _o.setEffectNode(_oEffectNode);
    long _oType = type();
    _o.setType(_oType);
  }
  public static int pack(FlatBufferBuilder builder, TransformNodeT _o) {
    if (_o == null) return 0;
    int _name = _o.getName() == null ? 0 : builder.createString(_o.getName());
    int _transform = _o.getTransform() == null ? 0 : me.hydos.trifecta.flatbuffers.Titan.Model.Transform.pack(builder, _o.getTransform());
    int _effectNode = _o.getEffectNode() == null ? 0 : builder.createString(_o.getEffectNode());
    startTransformNode(builder);
    addName(builder, _name);
    addTransform(builder, _transform);
    addScalePivot(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getScalePivot()));
    addRotatePivot(builder, me.hydos.trifecta.flatbuffers.Titan.Model.Vec3.pack(builder, _o.getRotatePivot()));
    addParentIdx(builder, _o.getParentIdx());
    addRigIdx(builder, _o.getRigIdx());
    addEffectNode(builder, _effectNode);
    addType(builder, _o.getType());
    return endTransformNode(builder);
  }
}
