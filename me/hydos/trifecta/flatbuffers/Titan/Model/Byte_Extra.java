...
public final class Byte_Extra extends Table {
  ...
  public Byte_ExtraT unpack() {
    Byte_ExtraT _o = new Byte_ExtraT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(Byte_ExtraT _o) {
    byte _oValue = value();
    _o.setValue(_oValue);
  }
  public static int pack(FlatBufferBuilder builder, Byte_ExtraT _o) {
    if (_o == null) return 0;
    return createByte_Extra(
      builder,
      _o.getValue());
  }
}
