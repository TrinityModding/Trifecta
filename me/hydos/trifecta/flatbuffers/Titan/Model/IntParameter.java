...
public final class IntParameter extends Table {
  ...
  public IntParameterT unpack() {
    IntParameterT _o = new IntParameterT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(IntParameterT _o) {
    String _oIntName = intName();
    _o.setIntName(_oIntName);
    int _oIntValue = intValue();
    _o.setIntValue(_oIntValue);
  }
  public static int pack(FlatBufferBuilder builder, IntParameterT _o) {
    if (_o == null) return 0;
    int _intName = _o.getIntName() == null ? 0 : builder.createString(_o.getIntName());
