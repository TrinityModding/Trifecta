...
public final class MorphAccessor extends Table {
  ...
  public MorphAccessorT unpack() {
    MorphAccessorT _o = new MorphAccessorT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(MorphAccessorT _o) {
    long _oUnk0 = unk0();
    _o.setUnk0(_oUnk0);
  ...
  public static int pack(FlatBufferBuilder builder, MorphAccessorT _o) {
    if (_o == null) return 0;
    return createMorphAccessor(
      builder,
      _o.getUnk0(),
      _o.getAttribute(),
      _o.getUnk1(),
