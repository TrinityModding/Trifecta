...
public final class SamplerState extends Table {
  ...
  public SamplerStateT unpack() {
    SamplerStateT _o = new SamplerStateT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(SamplerStateT _o) {
    long _oSamplerState0 = samplerState0();
    _o.setSamplerState0(_oSamplerState0);
    long _oSamplerState1 = samplerState1();
    _o.setSamplerState1(_oSamplerState1);
    long _oSamplerState2 = samplerState2();
    _o.setSamplerState2(_oSamplerState2);
    long _oSamplerState3 = samplerState3();
    _o.setSamplerState3(_oSamplerState3);
    long _oSamplerState4 = samplerState4();
    _o.setSamplerState4(_oSamplerState4);
    long _oSamplerState5 = samplerState5();
    _o.setSamplerState5(_oSamplerState5);
    long _oSamplerState6 = samplerState6();
    _o.setSamplerState6(_oSamplerState6);
    long _oSamplerState7 = samplerState7();
    _o.setSamplerState7(_oSamplerState7);
    long _oSamplerState8 = samplerState8();
    _o.setSamplerState8(_oSamplerState8);
    long _oRepeatU = repeatU();
    _o.setRepeatU(_oRepeatU);
    long _oRepeatV = repeatV();
    _o.setRepeatV(_oRepeatV);
    long _oRepeatW = repeatW();
    _o.setRepeatW(_oRepeatW);
    if (borderColor() != null) borderColor().unpackTo(_o.getBorderColor());
    else _o.setBorderColor(null);
  }
  public static int pack(FlatBufferBuilder builder, SamplerStateT _o) {
    if (_o == null) return 0;
    startSamplerState(builder);
    addSamplerState0(builder, _o.getSamplerState0());
    addSamplerState1(builder, _o.getSamplerState1());
    addSamplerState2(builder, _o.getSamplerState2());
    addSamplerState3(builder, _o.getSamplerState3());
    addSamplerState4(builder, _o.getSamplerState4());
    addSamplerState5(builder, _o.getSamplerState5());
    addSamplerState6(builder, _o.getSamplerState6());
    addSamplerState7(builder, _o.getSamplerState7());
    addSamplerState8(builder, _o.getSamplerState8());
    addRepeatU(builder, _o.getRepeatU());
    addRepeatV(builder, _o.getRepeatV());
    addRepeatW(builder, _o.getRepeatW());
    addBorderColor(builder, me.hydos.trifecta.flatbuffers.Titan.Model.RGBA.pack(builder, _o.getBorderColor()));
    return endSamplerState(builder);
  }
}
